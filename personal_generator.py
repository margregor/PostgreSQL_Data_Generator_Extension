...
class PersonalGenerator:
    ...
    last_names = unisex_last_names + male_last_names
    ...
    def get_first_name(self):
        return self.random_choice(self.first_names_male) if self.is_male else  self.random_choice(self.first_names_female)
    
    def get_last_name(self):
        return self.random_choice(self.last_names) if self.is_male else  self.random_choice(self.unisex_last_names)
